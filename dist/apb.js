...
var apb = /** @class */ (function () {
    ...
    apb.prototype.transformParallelState = function (stateName, stateConfig, States, DecoratorFlags) {
        ...
        var mergeParallelOutputStateName = ("merge_" + stateName.toLowerCase()).slice(0, 128);
        var mergeParallelOutputState = {
            Type: "Task",
        ...
        if (!this.isDefaultRetryDisabled(stateName)) {
            Object.assign(mergeParallelOutputState, { Retry: [constants_1.DEFAULT_RETRY] });
        }
        if (End === undefined) {
        ...
        return _a = {},
            _a[stateName] = Output,
            _a[mergeParallelOutputStateName] = mergeParallelOutputState,
            _a;
    };
