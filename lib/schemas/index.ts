...
export const NestedDataTestExpression = Joi.object({
  ...
  IsBoolean: Joi.boolean().valid(true),
  IsNull: Joi.boolean().valid(true),
  IsPresent: Joi.boolean().valid(true),
  IsNumeric: Joi.boolean().valid(true),
  IsString: Joi.boolean().valid(true),
  IsTimestamp: Joi.boolean().valid(true),
}).xor(
  "StringEquals",
  "StringEqualsPath",
  "StringLessThan",
